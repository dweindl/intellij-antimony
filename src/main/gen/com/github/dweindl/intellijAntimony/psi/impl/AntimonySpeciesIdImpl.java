...
public class AntimonySpeciesIdImpl extends ASTWrapperPsiElement implements AntimonySpeciesId {

  public AntimonySpeciesIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AntimonyVisitor visitor) {
    visitor.visitSpeciesId(this);
  }
