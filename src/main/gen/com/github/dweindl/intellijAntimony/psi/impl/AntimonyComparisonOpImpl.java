...
public class AntimonyComparisonOpImpl extends ASTWrapperPsiElement implements AntimonyComparisonOp {

  public AntimonyComparisonOpImpl(@NotNull ASTNode node) {
    super(node);
  }
