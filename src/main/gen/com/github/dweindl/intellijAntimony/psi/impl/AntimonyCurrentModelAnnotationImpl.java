...
public class AntimonyCurrentModelAnnotationImpl extends ASTWrapperPsiElement implements AntimonyCurrentModelAnnotation {

  public AntimonyCurrentModelAnnotationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AntimonyVisitor visitor) {
    visitor.visitCurrentModelAnnotation(this);
  }
