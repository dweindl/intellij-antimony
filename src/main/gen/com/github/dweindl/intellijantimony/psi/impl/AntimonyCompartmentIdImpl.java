...
public class AntimonyCompartmentIdImpl extends ASTWrapperPsiElement implements AntimonyCompartmentId {

  public AntimonyCompartmentIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AntimonyVisitor visitor) {
    visitor.visitCompartmentId(this);
  }
