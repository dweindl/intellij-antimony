...
public class AntimonyModifierIdImpl extends ASTWrapperPsiElement implements AntimonyModifierId {

  public AntimonyModifierIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AntimonyVisitor visitor) {
    visitor.visitModifierId(this);
  }
