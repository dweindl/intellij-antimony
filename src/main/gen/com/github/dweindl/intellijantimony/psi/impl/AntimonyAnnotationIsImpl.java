...
public class AntimonyAnnotationIsImpl extends ASTWrapperPsiElement implements AntimonyAnnotationIs {

  public AntimonyAnnotationIsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AntimonyVisitor visitor) {
    visitor.visitAnnotationIs(this);
  }
