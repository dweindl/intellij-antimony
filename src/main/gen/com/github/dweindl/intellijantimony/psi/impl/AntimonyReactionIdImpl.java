...
public class AntimonyReactionIdImpl extends ASTWrapperPsiElement implements AntimonyReactionId {

  public AntimonyReactionIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AntimonyVisitor visitor) {
    visitor.visitReactionId(this);
  }
