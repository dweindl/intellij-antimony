...
public class AntimonyEventAssignmentImpl extends ASTWrapperPsiElement implements AntimonyEventAssignment {

  public AntimonyEventAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
